package com.marsya.idn.foodapp.adapter
...
import com.marsya.idn.foodapp.activity.DetailActivity2
import com.marsya.idn.foodapp.databinding.ItemRecipeBinding
        ...
        with(holder) {
            with(listRecipes[position]){
                ...
                holder.itemView.setOnClickListener {
                    ...
                    intentToDetail.putExtra(DetailActivity2.RECIPES_DATA, dataSend)
